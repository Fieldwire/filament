 ...
 */
class MultipleModelViewer(
    val engine: Engine,
    private val uiHelper: UiHelper
) : android.view.View.OnTouchListener {
    var assets: MutableList<FilamentAsset> = mutableListOf()
        private set
    ...
    lateinit var gestureDetector: FWGestureDetector
    ...
    init {
        ...
        camera = engine.createCamera(engine.entityManager.create()).apply { setExposure(
            kAperture,
            kShutterSpeed,
            kSensitivity
        ) }
    ...
    constructor(
        ...
        gestureDetector = FWGestureDetector(surfaceView, view, cameraManipulator)
    ...
    constructor(
        ...
        gestureDetector = FWGestureDetector(textureView, view, cameraManipulator)
     ...
     */
    fun loadModelGlbs(buffers: List<Buffer>) {
        destroyModel()

        buffers.forEach { buffer ->
            assetLoader.createAsset(buffer)?.let {
                assets.add(it)
                resourceLoader.asyncBeginLoad(it)
    ...
    fun render(frameTimeNanos: Long) {
        ...
        assets.forEach { populateScene(it) }
    ...
    private fun addDetachListener(view: android.view.View) {
        view.addOnAttachStateChangeListener(object : android.view.View.OnAttachStateChangeListener {
            ...
            override fun onViewDetachedFromWindow(v: android.view.View) {
                ...
                engine.destroyView(this@MultipleModelViewer.view)
